      ...
      <view class="goods-section">
        ...
        <view class="g-item"
          ...
          <view class="right">
            ...
            <text class="spec"
                  v-for="(itemaa,indexaa) in item.arr"
                  :key='indexaa'>{{itemaa.name}}:{{itemaa.list}}</text>
            <view class="price-box">
      ...
      <view>
        <view class="pay-type-list"
          ...
          <view class="type-item b-b"
                v-if="item.checked"
                @click="changePayType(item.payType,index)">
            <image :src="item.index == chooseTarget ? item.img1 : item.img"
                   mode=""
                   style="height: 30rpx;width: 30rpx;margin-right: 20rpx;"></image>
