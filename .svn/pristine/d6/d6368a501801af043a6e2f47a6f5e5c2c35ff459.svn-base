<template>
  <view class="container">
    ...
    <view class="carousel-section">
      ...
      <swiper class="carousel"
        ...
        <swiper-item v-for="(item, index) in carouselList"
          ...
          <easyLoadimage :image-src="item.ImageUrl"
    ...
    <view class="cate-section">
      ...
      <view class="cate-item"
            @click="jump('/pages/category/category', 18)">
        <image src="/static/temp/c11.jpg"></image>
        <text>日用百货</text>
      </view>
      <view class="cate-item"
            @click="jump('/pages/category/category', 20)">
